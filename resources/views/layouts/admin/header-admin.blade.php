...
<header class="main-header">
    <a href="{{ url('/admin')}}" class="logo"><img src="@if(!$ss->logo) {{ url('assets/logo/logo.png') }} @else {{ url('assets/logo/'.$ss->logo) }} @endif" style="height: 38px; display: inline-block; margin-right: 10px;"></a>
